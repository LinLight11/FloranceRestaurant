const articles = [
  {
    ...
    body: [
      'The art of pairing wine and cuisine begins with a simple idea: the right combination can make both the wine and the dish taste better. It is not about following strict rules, but about understanding how flavors, textures, and aromas come together to create balance.',
  ...
  {
    id: 'plate',
    quote: 'Some moments are meant to be savored, not hurried.',
    author: 'Anonymous Chef',
    body: [
      'A meal is never just about what sits on the plate. The candlelight, the pace of conversation, the pause between courses — these shape memory as much as flavor does.',
      'Because true hospitality is not simply about serving something beautiful. It is about creating a feeling that stays with you. A moment you remember not only for what you tasted, but for how the evening made you feel — welcomed, inspired, and entirely present.',
  ...
  },
  {
    ...
    body: [
      'Dinner night at Florance is less an event and more a ritual — a deliberate pause carved out of a busy week.',
      'Each course arrives with its own quiet rhythm, giving conversation room to breathe between plates. Nothing is rushed, and nothing feels incidental. The time between dishes becomes part of the experience — a chance to linger over a glass, exchange stories, or simply enjoy the atmosphere around the table.',
  ...
  },
  {
    ...
    body: [
        'Each harvest tells its own story, shaped by weather, soil, and the patience of those who tend the vines. No two seasons are quite the same. A change in temperature, a passing rain, or a longer stretch of sunlight can leave its mark on the grapes, giving each vintage a character entirely its own.',
        'The decisions made in these few short weeks — when to pick, how to press, how long to wait — define the character of a wine for years to come. Behind every bottle is a process of careful observation and restraint, where timing matters as much as technique and patience becomes part of the craft.',
